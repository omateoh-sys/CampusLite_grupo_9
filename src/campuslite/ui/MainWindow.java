...
public class MainWindow extends JFrame {
    ...
    private JPanel crearStats() {
        ...
        lblNumEstudiantes = new JLabel(str(gestor.getStudents().size()), SwingConstants.CENTER);
        lblNumCursos      = new JLabel(str(gestor.getCourses().size()),      SwingConstants.CENTER);
        lblNumMaestros    = new JLabel(str(gestor.getTeachers().size()),    SwingConstants.CENTER);
    ...
    public void actualizarStats() {
        lblNumEstudiantes.setText(str(gestor.getStudents().size()));
        lblNumCursos     .setText(str(gestor.getCourses().size()));
        lblNumMaestros   .setText(str(gestor.getTeachers().size()));
    }
