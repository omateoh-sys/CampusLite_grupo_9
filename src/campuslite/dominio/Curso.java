...
public class Curso {
    ...
    private Maestro maestro;  // puede ser null si no tiene asignado
    ...
    public void setMaestro(Maestro maestroSel) {
    ...
    public boolean eliminarEvaluacion(Evaluacion evaluacion) {
    ...
    public double sumaPonderaciones() {
        double suma = 0;
        for (Evaluacion e : evaluaciones) suma += e.getPonderacion();
        return suma;
    }
